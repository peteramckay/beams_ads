    ...
    $.fn.accordion = function(config) {
        ...
        this.each(function() {
            ...
            accordion.delegate(".accordion-opener", "click", function(e) {
               ...
               // alert(".accordion-opener"+ e.target);
                var clicked     = $(this),
				...
				//alert("!clickedLi");
					...
					//alert("if !clickedLi");
						...
						//alert("defaults.canToggle");
                            panel.trigger("panel-close");
                        }
                    } else {
					//alert("else !clickedLi");
